...
export class ExportService {
  ...
  constructor(
    ...
    public async caseToPdf(conversation:any,closing:boolean=true,skills:boolean=true,transcript:boolean=true){
      console.log(conversation)
      this.toast.showLoader('Het document wordt gegenereerd...')
  
      let doc:any = {
        title: 'Gespreksverslag met '+conversation.role,
    ...
    private async addImageToPdf(pdf:any, imageUrl:string, x:number, y:number, width:number, height:number) {
      try {
    ...
    private getFeedbackChat(conversation:any,index:number,type:string){
    ...
    private getAttitude(conversation:any,index:number){
